...
%changelog
* Mon Aug 27 2018 Edgar Fajardo <emfajard@ucsd.edu> - 3.19.8-1
- Fix GRACC warnings (SOFTWARE-3191)
...
- Disable deprecated probes (e.g. osg-version) by default (SOFTWARE-3180)
- Have java-version-probe correctly detect tomcat on EL7 (SOFTWARE-3021)
